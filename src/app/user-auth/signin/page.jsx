...
const Signin = () => {
    ...
    //                 router.push("/user"); // redirect to OTP page
    //             }
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            showSuccessToast(result.message || "Account Logged In Successfully");
                ...
                <form onSubmit={handleSubmit(onSubmit)} autoComplete="off">
                    ...
                    <div className="text-start mt-4">
                        ...
                        <div className="register_link">
                            <h5>
                                Already have an account? <Link href="/user-auth/signup">Sign Up</Link>
                            </h5>
                        </div>
                    </div>
                </form>
